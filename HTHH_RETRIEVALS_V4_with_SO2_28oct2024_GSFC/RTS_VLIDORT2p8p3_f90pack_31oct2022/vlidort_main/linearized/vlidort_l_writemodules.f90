...
!  3/28/14. Changes for Version 2.7. remove LTE linearization references. Add LBBF
      ...
      SUBROUTINE VLIDORT_WRITE_LIN_INPUT ( ATMOS_INDEX, &
...
!mick mod 9/22/2022 - added "ATMOS_INDEX" string to output file name
      ...
      OPEN (OUTUNIT,file = 'VLIDORT_WRITE_LIN_INPUT_'//AI//'.dbg',status = 'replace')
...
!
      ...
      SUBROUTINE VLIDORT_WRITE_LIN_SUP_BRDF_INPUT ( ATMOS_INDEX, &
...
!mick mod 9/22/2022 - added "ATMOS_INDEX" string to output file name
      ...
      WRITE(AI,'(i4.4)') ATMOS_INDEX
      OPEN (OUTUNIT,file = 'VLIDORT_WRITE_LIN_SUP_BRDF_INPUT_'//AI//'.dbg',status = 'replace')
...
!
      ...
      SUBROUTINE VLIDORT_WRITE_LPS_SUP_SS_INPUT ( ATMOS_INDEX, &
...
!mick mod 9/22/2022 - added "ATMOS_INDEX" string to output file name
      ...
      WRITE(AI,'(i4.4)') ATMOS_INDEX
      OPEN (OUTUNIT,file = 'VLIDORT_WRITE_LPS_SUP_SS_INPUT_'//AI//'.dbg',status = 'replace')
...
!
      ...
      SUBROUTINE VLIDORT_WRITE_LCS_SUP_SS_INPUT ( ATMOS_INDEX, &
...
!mick mod 9/22/2022 - added "ATMOS_INDEX" string to output file name
      ...
      WRITE(AI,'(i4.4)') ATMOS_INDEX
      OPEN (OUTUNIT,file = 'VLIDORT_WRITE_LCS_SUP_SS_INPUT_'//AI//'.dbg',status = 'replace')
...
!
      ...
      SUBROUTINE VLIDORT_WRITE_LIN_SUP_SLEAVE_INPUT ( ATMOS_INDEX, &
...
!mick mod 9/22/2022 - added "ATMOS_INDEX" string to output file name
      ...
      WRITE(AI,'(i4.4)') ATMOS_INDEX
      OPEN (OUTUNIT,file = 'VLIDORT_WRITE_LIN_SUP_SLEAVE_INPUT_'//AI//'.dbg',status = 'replace')
