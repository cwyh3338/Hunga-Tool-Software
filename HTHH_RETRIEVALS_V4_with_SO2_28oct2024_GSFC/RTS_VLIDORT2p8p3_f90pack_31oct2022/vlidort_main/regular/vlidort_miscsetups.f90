...
!mick fix 10/29/2022 - SAVE attribute removed from these 15 arrays to make VLIDORT threadsafe
      DOUBLE PRECISION :: DF_L ( 0:MAXMOMENTS )
      DOUBLE PRECISION :: DF_LP1 ( 0:MAXMOMENTS )
      DOUBLE PRECISION :: DF_2LP1 ( 0:MAXMOMENTS )
      DOUBLE PRECISION :: DF_LSQM4 ( 0:MAXMOMENTS )
      DOUBLE PRECISION :: DF_RT_LP3XLM1 ( 0:MAXMOMENTS )
      DOUBLE PRECISION :: ZHELP ( 0:MAXMOMENTS )
      DOUBLE PRECISION :: UMXSQ ( MAX_ALLSTRMS_P1 )
      DOUBLE PRECISION :: RT_UMXSQ ( MAX_ALLSTRMS_P1 )
      DOUBLE PRECISION :: UPXSQ_D_UMXSQ ( MAX_ALLSTRMS_P1 )
      DOUBLE PRECISION :: PLEG20 ( MAX_ALLSTRMS_P1 )
      DOUBLE PRECISION :: M2X_D_UMXSQ ( MAX_ALLSTRMS_P1 )
      DOUBLE PRECISION :: XUMXSQ ( MAX_ALLSTRMS_P1 )
      DOUBLE PRECISION :: X_RT_UMXSQ ( MAX_ALLSTRMS_P1 )
      DOUBLE PRECISION :: X2LP1 ( 0:MAXMOMENTS, MAX_ALLSTRMS_P1 )
...
!  Only for the first fundamental harmonic
!mick fix  7/28/2014 - do for each fourier now to make VLIDORT threadsafe
!mick fix 10/29/2022 - fix later turned off for a time as it was thought not
!                      needed, but this was incorrect (reactivated now!)
