...
!
      ...
      SUBROUTINE VLIDORT_CUSER_SOLUTION ( &
        ...
        DO_LAYSCAT, FLUX_FACTOR, DFLUX, BEAM_CUTOFF, QUAD_HALFWTS,          & ! Input flux/quad/Bookkeep
...
!  No particular solution if beyond the cutoff layer
!    OR if no scattering in this layer
!    --> Zero the boundary layer values and exit
