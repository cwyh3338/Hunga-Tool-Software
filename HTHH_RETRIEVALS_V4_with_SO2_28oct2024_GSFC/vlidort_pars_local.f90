...
!      INTEGER, PARAMETER :: MAXLAYERS = 66
!      INTEGER, PARAMETER :: MAXLAYERS = 100
      INTEGER, PARAMETER :: MAXLAYERS = 160
...
!    (Use full range for exact single scatter calculations)
      ...
      INTEGER, PARAMETER :: MAXMOMENTS_INPUT = 620
...
!      INTEGER, PARAMETER :: MAX_GEOMETRIES = MAXBEAMS * MAX_USER_VZANGLES * MAX_USER_RELAZMS ! Lattice
!      INTEGER, PARAMETER :: MAX_GEOMETRIES = MAXBEAMS * MAX_USER_VZANGLES                    ! Doublet
       INTEGER, PARAMETER :: MAX_GEOMETRIES = MAX_USER_OBSGEOMS                               ! Obsgeom
...
!   Refractive Geometry setting: Watch out for Kill. Memory Hog
